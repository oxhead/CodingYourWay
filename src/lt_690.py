...
class Solution:
    def getImportance(self, employees, id):
        ...
        while queue:
            ...
            for subordinate_id in employee.subordinates:
                queue.append(records[subordinate_id])
        return total
    ...
    def getImportance_dfs(self, employees, id):
        ...
        """
        def dfs(employee):
            return employee.importance + sum([dfs(records[e]) for e in employee.subordinates])
        total = 0
        records = {employee.id: employee for employee in employees}        
        return dfs(records[id])
...
if __name__ == '__main__':
    ...
    for test_case in test_cases:
        ...
        employee_data_list, id = test_case[0]
        employees = []
